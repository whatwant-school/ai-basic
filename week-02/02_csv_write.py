...
logging.config.fileConfig('02_logging.cfg')
...
try:
    with open("02_customers.csv", "r") as customer_data:
...
logger.info('Write USA only data at {0}'.format("02_customers_USA_only.csv",))
